...
void displayMenu()
{
	...
	cout << "    6: Print the person with the least amount of votes" << endl;
	cout << "    7: To exit" << endl;
}
...
void processChoice(CandidateList& candidateList)
{
	...
	while (choice != 7)
	{
		...
		case 5:
			...
			// print person with least amount of votes
		case 6:
			cout << endl;
			if (candidateList.isEmpty())
				cerr << "*** List is empty.\n";
			...
			{
				id = candidateList.getTheBiggestLoser();
				if (id != 0)
				{
					cout << "Candidate with the least amount of votes: ";
					candidateList.printCandidateName(id);
					cout << endl;
					candidateList.printCandidateTotalVotes(id);
				}
